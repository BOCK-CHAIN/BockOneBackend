...
app.get('/api/orventus/health', (req, res) => {
  res.json({ status: 'ok', service: 'orventus-backend' });
});

app.use('/api/orventus/api/v1/auth', authRoutes);
app.use('/api/orventus/api/v1/users', userRoutes);
app.use('/api/orventus/api/v1/rides', rideRoutes);
app.use('/api/orventus/api/v1/stats', statsRoutes); // <-- ADD THIS LINE
app.use('/api/orventus/api/v1/misc', miscRoutes);
app.use('/api/orventus/api/v1/vehicles', vehicleRoutes); // Add this line
app.use('/api/orventus/api/v1/promocodes', promoCodeRoutes); // Add this line
app.use('/api/orventus/api/v1/reviews', reviewRoutes); // Add this line
app.use('/api/orventus/api/v1/documents', documentTypeRoutes); // Add this line
app.use('/api/orventus/api/v1/settings', settingsRoutes);
app.use('/api/orventus/api/v1/notifications', notificationRoutes);

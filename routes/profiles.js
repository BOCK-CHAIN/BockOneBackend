...
import { ensureProfileExists } from '../utils/profile.js';
 ...
 * Create (or ensure) profile for current user.
 * Accepts optional profile fields to update immediately.
 */
router.post('/me', requireAuth, async (req, res) => {
  try {
    ...
    console.error('❌ Profile ensure endpoint error:', error);
    res.status(500).json({
      error: 'Internal server error',
